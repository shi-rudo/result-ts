...
describe('Result.pipe', () => {
    it('returns the same instance when no operators are provided', () => {
        const r = ok(1);
    ...
    it('works with pipeable operators in the Ok case', () => {
        const out = ok<number, string>(2).pipe(
            map((n) => n + 1),
    ...
    it('can switch to Err within the pipe', () => {
        const out = ok<number, string>(2).pipe(
    ...
    it('pipes multiple Result operators in sequence', () => {
...
describe('Result.tryCatch', () => {
    it('catches exceptions and turns them into Err', () => {
    ...
    it('skips tryCatch when source is already Err', () => {
        const throwingFn = vi.fn(() => {
    ...
    it('uses a custom errorMapper to transform exceptions', () => {
        const throwingFn = vi.fn(() => {
...
describe('Result.tryCatchAsync', () => {
    it('catches async exceptions and turns them into Err', async () => {
    ...
    it('returns Ok when no exception is thrown in an async function', async () => {
    ...
    it('skips tryCatchAsync when source is already Err', async () => {
        const throwingFn = vi.fn(async () => {
            throw new Error('should not be called');
        });
    ...
    it('uses a custom errorMapper for async exceptions', async () => {
        const throwingFn = vi.fn(async () => {
...
describe('Result.tryMap', () => {
    ...
    it('skips tryMap when source is already Err', () => {
...
describe('Result.tryMapAsync', () => {
    ...
    it('turns a rejected Promise into Err', async () => {
    ...
    it('skips tryMapAsync when source is already Err', async () => {
...
describe('Result.pipeAsync', () => {
    it('returns the same instance when no operators are provided', async () => {
        const r = ok(1);
    ...
    it('pipes multiple async Result functions in sequence', async () => {
    ...
    it('works with async operators too (mapAsync / tapAsync / filterAsync)', async () => {
        const seen: Array<string> = [];
    ...
    describe('filterAsync coverage', () => {
        ...
        it('filterAsync calls errorFn on Ok but false predicate', async () => {
            const result = ok(5);
    ...
    describe('tapAsync coverage', () => {
        it('tapAsync calls the ok callback', async () => {
            const seen: string[] = [];
            const result = ok(42);
        ...
        it('tapAsync calls the err callback', async () => {
            const seen: string[] = [];
